...
/// after the post-commit full rescan. Unlike `stress_random`, this replays the
/// exact operation sequence directly (independent of proptest RNG/strategy),
/// so the scenario always runs and guards the fix.
#[test]
fn stress_regression_stale_index_after_commit() {
    use AbstractOp::*;
    let ops: Vec<AbstractOp> = vec![
        Touch {
            idx: 11805740887947177360,
        },
        EditFile {
            idx: 16172331740552606779,
            content_seed: 658362763,
        },
        EditFile {
            idx: 15583428591709383853,
            content_seed: 959932347,
        },
        CreateFile {
            seed: 3931677194,
            content_seed: 3741630760,
        },
        RenameFile {
            idx: 10904465323748885299,
            new_seed: 2279324670,
        },
        EditFile {
            idx: 9420001873471413265,
            content_seed: 2114867802,
        },
        EditFile {
            idx: 213141289566213885,
            content_seed: 560732827,
        },
        EditFile {
            idx: 17035572278797292009,
            content_seed: 3808313786,
        },
        CreateFile {
            seed: 1288265487,
            content_seed: 1533838042,
        },
        EditFile {
            idx: 16473729680435813293,
            content_seed: 1008536355,
        },
        Noop,
        EditFile {
            idx: 5398337378624802944,
            content_seed: 1867267587,
        },
        EditFile {
            idx: 8551649030560368528,
            content_seed: 2795207371,
        },
        EditFile {
            idx: 481097026290699171,
            content_seed: 2327194851,
        },
        EditFile {
            idx: 16127721863741462430,
            content_seed: 259019344,
        },
        EditFile {
            idx: 12499722135620715652,
            content_seed: 710330684,
        },
        Noop,
        EditFile {
            idx: 8570312264332927846,
            content_seed: 20660474,
        },
        EditFile {
            idx: 8235918596759853707,
            content_seed: 3895597068,
        },
        EditFile {
            idx: 12941454977835821598,
            content_seed: 974440776,
        },
        CreateFile {
            seed: 2370169947,
            content_seed: 3173097146,
        },
        EditFile {
            idx: 17976810772660212547,
            content_seed: 1324367109,
        },
        EditFile {
            idx: 9502968218335991677,
            content_seed: 4023431064,
        },
        EditFile {
            idx: 6867642529007482379,
            content_seed: 207981211,
        },
        CreateFile {
            seed: 570877898,
            content_seed: 1583247379,
        },
        EditFile {
            idx: 7954117886944662117,
            content_seed: 1193244670,
        },
        EditFile {
            idx: 2859309324154804229,
            content_seed: 669423541,
        },
        EditFile {
            idx: 1701666328639270148,
            content_seed: 3533870941,
        },
        EditFile {
            idx: 9409088379085591352,
            content_seed: 132132514,
        },
        CreateSubdirFile {
            dir_seed: 16362,
            file_seed: 52030,
            content_seed: 1374259669,
        },
        EditFile {
            idx: 13262913709196533433,
            content_seed: 2320968118,
        },
        EditFile {
            idx: 17763858399044545684,
            content_seed: 356795223,
        },
        GitAddAll,
        GitAddAll,
        EditFile {
            idx: 15775096968456010165,
            content_seed: 1772666100,
        },
        CreateFile {
            seed: 2452057527,
            content_seed: 4111477598,
        },
        EditFile {
            idx: 10711976377011651566,
            content_seed: 3912798245,
        },
        EditFile {
            idx: 9546828938565340524,
            content_seed: 172130614,
        },
        EditFile {
            idx: 13343766455516594408,
            content_seed: 4263257980,
        },
        EditFile {
            idx: 3019554710255922240,
            content_seed: 2030698787,
        },
        EditFile {
            idx: 10405611055126420472,
            content_seed: 1193589142,
        },
        EditFile {
            idx: 17138669581083326405,
            content_seed: 2903728507,
        },
        GitignoreAppend {
            pattern_seed: 54248,
        },
        EditFile {
            idx: 13072623131577163943,
            content_seed: 1483932899,
        },
        DeleteFile {
            idx: 12869318557852831815,
        },
        EditFile {
            idx: 6824133502332012157,
            content_seed: 3150001556,
        },
        EditFile {
            idx: 14438183751086260985,
            content_seed: 3158759791,
        },
        EditFile {
            idx: 3246005478687480560,
            content_seed: 1237031794,
        },
        EditFile {
            idx: 18419405778222487428,
            content_seed: 564314178,
        },
        DeleteFile {
            idx: 5831672858052749534,
        },
        GitCommit { msg_seed: 6624 },
        RenameFile {
            idx: 9595327710957667341,
            new_seed: 3574446333,
        },
        EditFile {
            idx: 11366319046220637326,
            content_seed: 3919865486,
        },
        CreateFile {
            seed: 906013144,
            content_seed: 1799214899,
        },
        EditFile {
            idx: 6771264237902804639,
            content_seed: 2901771864,
        },
        EditFile {
            idx: 5877801695508394108,
            content_seed: 3324479019,
        },
        CreateSubdirFile {
            dir_seed: 47588,
            file_seed: 6835,
            content_seed: 4279222285,
        },
        GitignoreAppend {
            pattern_seed: 41743,
        },
        GitCommit { msg_seed: 63391 },
    ];
    run_stress_scenario(&ops);
}
